...
contribution: "Implemented the BACI ingestion, network construction, Leiden detection, lineage matching, robustness outputs, tests, figures, and economic interpretation workflow."
